...
class MomentDETRPredictor:
    ...
    def localize_moment(self, video_path, query_list):
        ...
        assert n_frames <= 75, "The positional embedding of this pretrained Moment-DETR only support video up " \
...
def run_example(video_paths, query_text):
    ...
    for vid_path in video_paths:
        prediction = moment_detr_predictor.localize_moment(
...
if __name__ == "__main__":
    ...
    vid_splits = '../../assets/video-splits/'
